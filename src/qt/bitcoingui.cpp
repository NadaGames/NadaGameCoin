                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NADACoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NADACoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NADACoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NADACoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about NADACoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NADACoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NADACoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NADACoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a NADACoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NADACoin Core help message to get a list with possible NADACoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NADACoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NADACoin network", "", count));
}
...
{
    QString strTitle = tr("NADACoin Core"); // default title
