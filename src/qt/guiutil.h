...
/** Utility functions used by the NADACoin Qt UI.
 */
namespace GUIUtil
{
...
// Render NADACoin addresses in monospace font
...
// Parse "NADACoin:" URI into recipient object, return true on successful parsing
