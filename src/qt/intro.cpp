...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NADACoin Core"),
     ...
     * override -datadir in the NADACoin.conf file in the default data directory
     * (to be consistent with NADACoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
