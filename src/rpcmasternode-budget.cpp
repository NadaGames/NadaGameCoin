...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"NADACoin-address\" monthy-payment\n"
            ...
            "5. \"NADACoin-address\":   (string, required) NADACoin address to send payments to\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"NADACoin-address\" monthy-payment \"fee-tx\"\n"
