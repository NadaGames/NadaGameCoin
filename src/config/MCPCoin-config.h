/* src/config/NADACoin-config.h.  Generated from NADACoin-config.h.in by configure.  */
/* src/config/NADACoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NADA_CONFIG_H

#define NADA_CONFIG_H
...
#define PACKAGE_NAME "NADACoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NADACoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "NADACoin"
