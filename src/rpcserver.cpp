...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NADACoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "NADACoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NADACoin features */
        {"NADACoin", "masternode", &masternode, true, true, false},
        {"NADACoin", "listmasternodes", &listmasternodes, true, true, false},
        {"NADACoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"NADACoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"NADACoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"NADACoin", "masternodedebug", &masternodedebug, true, true, false},
        {"NADACoin", "startmasternode", &startmasternode, true, true, false},
        {"NADACoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"NADACoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"NADACoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"NADACoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"NADACoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"NADACoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"NADACoin", "mnbudget", &mnbudget, true, true, false},
        {"NADACoin", "preparebudget", &preparebudget, true, true, false},
        {"NADACoin", "submitbudget", &submitbudget, true, true, false},
        {"NADACoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"NADACoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"NADACoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"NADACoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"NADACoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"NADACoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"NADACoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"NADACoin", "checkbudgets", &checkbudgets, true, true, false},
        {"NADACoin", "mnsync", &mnsync, true, true, false},
        {"NADACoin", "spork", &spork, true, true, false},
        {"NADACoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"NADACoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use NADACoind, or the -server option to NADACoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> NADACoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51572/\n";
}
