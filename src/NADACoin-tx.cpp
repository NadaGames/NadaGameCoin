...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NADACoin Core NADACoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  NADACoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NADACoin transaction") + "\n" +
                               "  NADACoin-tx [options] -create [commands]   " + _("Create hex-encoded NADACoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NADACoin transaction
