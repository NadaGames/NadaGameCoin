...
In order to support loading of multiple wallets in NADACoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is NADACoin.cpp.
...
Changes to NADACoin.cpp
----------------------
NADACoin.cpp is the entry point into NADACoin-qt, and as such, will require some minor modifications to provide hooks for
